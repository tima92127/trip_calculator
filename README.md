...
показывает список найденных позиций с суммами. По клику на позицию сумма
(и, если поле описания пустое, название позиции) подставляется в форму
расхода — дальше как обычно выбирается плательщик и участники, на кого её
разнести.
...
- Скан чека с распознаванием позиций и сумм (экспериментально)
